...
| `/punishment` | MANAGE_GUILD | EPHEMERAL / 非公開 | PunishmentService | [Strike](21-strikes-and-punishments.md)、基盤§9.7 |
...
| `/setup`、`/messagelog`、`/modlog`、`/serverlog`、`/voicelog`、`/timezone`、`/modrole`、`/settings` | MANAGE_GUILD | EPHEMERAL / 非公開 | SettingsService | [設定・ログ](40-configuration-and-logs.md)、共通§9.7 |
...
| `/lookup` | PUBLIC | EPHEMERAL / 非公開 | LookupService | [ツール・ボイス](50-tools-and-voice.md)、共通§9.7 |
